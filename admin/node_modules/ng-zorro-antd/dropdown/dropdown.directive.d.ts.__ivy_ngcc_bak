...
import { AfterViewInit, ElementRef, EventEmitter, OnChanges, OnDestroy, OnInit, SimpleChanges, ViewContainerRef } from '@angular/core';
...
export declare class NzDropDownDirective implements AfterViewInit, OnDestroy, OnChanges, OnInit {
    ...
    constructor(elementRef: ElementRef, overlay: Overlay, viewContainerRef: ViewContainerRef, platform: Platform);
    ngOnInit(): void;
