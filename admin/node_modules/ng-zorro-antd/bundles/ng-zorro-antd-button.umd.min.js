...
/*! *****************************************************************************
    ...
    ***************************************************************************** */function l(n,e,t,o){var r,a=arguments.length,i=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,t):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(n,e,t,o);else for(var s=n.length-1;s>=0;s--)(r=n[s])&&(i=(a<3?r(i):a>3?r(e,t,i):r(e,t))||i);return a>3&&i&&Object.defineProperty(e,t,i),i}function d(n,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(n,e)}Object.create;Object.create;var u=function(){function n(n,e,t,o){var r=this;this.elementRef=n,this.cdr=e,this.renderer=t,this.nzConfigService=o,this.nzBlock=!1,this.nzGhost=!1,this.nzSearch=!1,this.nzLoading=!1,this.nzDanger=!1,this.disabled=!1,this.tabIndex=null,this.nzType=null,this.nzShape=null,this.nzSize="default",this.destroy$=new a.Subject,this.loading$=new a.Subject,this.nzConfigService.getConfigChangeEventForComponent("button").pipe(i.takeUntil(this.destroy$)).subscribe((function(){r.cdr.markForCheck()}))}return n.prototype.haltDisabledEvents=function(n){this.disabled&&(n.preventDefault(),n.stopImmediatePropagation())},n.prototype.insertSpan=function(n,e){n.forEach((function(n){if("#text"===n.nodeName){var t=e.createElement("span"),o=e.parentNode(n);e.insertBefore(o,t,n),e.appendChild(t,n)}}))},n.prototype.assertIconOnly=function(n,e){var t=Array.from(n.childNodes),o=t.filter((function(n){return"I"===n.nodeName})).length,r=t.every((function(n){return"#text"!==n.nodeName}));t.every((function(n){return"SPAN"!==n.nodeName}))&&r&&1===o&&e.addClass(n,"ant-btn-icon-only")},n.prototype.ngOnChanges=function(n){n.nzLoading&&this.loading$.next(this.nzLoading)},n.prototype.ngAfterViewInit=function(){this.assertIconOnly(this.elementRef.nativeElement,this.renderer),this.insertSpan(this.elementRef.nativeElement.childNodes,this.renderer)},n.prototype.ngAfterContentInit=function(){var n=this;this.loading$.pipe(i.startWith(this.nzLoading),i.filter((function(){return!!n.nzIconDirectiveElement})),i.takeUntil(this.destroy$)).subscribe((function(e){var t=n.nzIconDirectiveElement.nativeElement;e?n.renderer.setStyle(t,"display","none"):n.renderer.removeStyle(t,"display")}))},n.prototype.ngOnDestroy=function(){this.destroy$.next(),this.destroy$.complete()},n.decorators=[{type:e.Component,args:[{selector:"button[nz-button], a[nz-button]",exportAs:"nzButton",preserveWhitespaces:!1,changeDetection:e.ChangeDetectionStrategy.OnPush,encapsulation:e.ViewEncapsulation.None,template:'\n    <i nz-icon nzType="loading" *ngIf="nzLoading"></i>\n    <ng-content></ng-content>\n  ',host:{"[class.ant-btn]":"true","[class.ant-btn-primary]":"nzType === 'primary'","[class.ant-btn-dashed]":"nzType === 'dashed'","[class.ant-btn-link]":"nzType === 'link'","[class.ant-btn-danger]":"nzType === 'danger'","[class.ant-btn-circle]":"nzShape === 'circle'","[class.ant-btn-round]":"nzShape === 'round'","[class.ant-btn-lg]":"nzSize === 'large'","[class.ant-btn-sm]":"nzSize === 'small'","[class.ant-btn-dangerous]":"nzDanger","[class.ant-btn-loading]":"nzLoading","[class.ant-btn-background-ghost]":"nzGhost","[class.ant-btn-block]":"nzBlock","[class.ant-input-search-button]":"nzSearch","[attr.tabindex]":"disabled ? -1 : (tabIndex === null ? null : tabIndex)","[attr.disabled]":"disabled || null","(click)":"haltDisabledEvents($event)"}}]}],n.ctorParameters=function(){return[{type:e.ElementRef},{type:e.ChangeDetectorRef},{type:e.Renderer2},{type:t.NzConfigService}]},n.propDecorators={nzIconDirectiveElement:[{type:e.ContentChild,args:[r.NzIconDirective,{read:e.ElementRef}]}],nzBlock:[{type:e.Input}],nzGhost:[{type:e.Input}],nzSearch:[{type:e.Input}],nzLoading:[{type:e.Input}],nzDanger:[{type:e.Input}],disabled:[{type:e.Input}],tabIndex:[{type:e.Input}],nzType:[{type:e.Input}],nzShape:[{type:e.Input}],nzSize:[{type:e.Input}]},l([o.InputBoolean(),d("design:type",Boolean)],n.prototype,"nzBlock",void 0),l([o.InputBoolean(),d("design:type",Boolean)],n.prototype,"nzGhost",void 0),l([o.InputBoolean(),d("design:type",Boolean)],n.prototype,"nzSearch",void 0),l([o.InputBoolean(),d("design:type",Boolean)],n.prototype,"nzLoading",void 0),l([o.InputBoolean(),d("design:type",Boolean)],n.prototype,"nzDanger",void 0),l([o.InputBoolean(),d("design:type",Boolean)],n.prototype,"disabled",void 0),l([t.WithConfig("button"),d("design:type",String)],n.prototype,"nzSize",void 0),n}();var g=function(){function n(){this.nzSize="default"}return n.decorators=[{type:e.Component,args:[{selector:"nz-button-group",exportAs:"nzButtonGroup",changeDetection:e.ChangeDetectionStrategy.OnPush,encapsulation:e.ViewEncapsulation.None,host:{"[class.ant-btn-group]":"true","[class.ant-btn-group-lg]":"nzSize === 'large'","[class.ant-btn-group-sm]":"nzSize === 'small'"},preserveWhitespaces:!1,template:"\n    <ng-content></ng-content>\n  "}]}],n.propDecorators={nzSize:[{type:e.Input}]},n}();var z=function(){function n(){}return n.decorators=[{type:e.NgModule,args:[{declarations:[u,g],exports:[u,g,c.ɵNzTransitionPatchModule,p.NzWaveModule],imports:[s.CommonModule,p.NzWaveModule,r.NzIconModule,c.ɵNzTransitionPatchModule]}]}],n}();n.NzButtonComponent=u,n.NzButtonGroupComponent=g,n.NzButtonModule=z,Object.defineProperty(n,"__esModule",{value:!0})}));
