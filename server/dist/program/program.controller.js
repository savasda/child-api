...
const program_dto_1 = require("./models/program.dto");
...
let ProgramController = class ProgramController {
    ...
    allPrograms() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.programService.getAll();
        });
    }
    oneProgram(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.programService.getById(data.id);
        });
    }
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.programService.update(id, data);
        });
    }
    create(program) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.programService.create(program);
        });
    }
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.programService.delete(id);
        });
    }
    uloadavatar(file) {
        return __awaiter(this, void 0, void 0, function* () {
...
], ProgramController.prototype, "allPrograms", null);
__decorate([
    common_1.Get(':id'),
    ...
    __metadata("design:returntype", Promise)
], ProgramController.prototype, "oneProgram", null);
__decorate([
    swagger_1.ApiBearerAuth(),
    swagger_1.ApiOkResponse({ description: 'Update program' }),
...
__decorate([
    swagger_1.ApiBearerAuth(),
    swagger_1.ApiOkResponse({ description: 'Create program' }),
    swagger_1.ApiUnauthorizedResponse(),
    common_1.Post(),
    common_1.UseGuards(new auth_guard_1.AuthGuard()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProgramController.prototype, "uloadavatar", null);
